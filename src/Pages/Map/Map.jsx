...
const Map = (props) => {
  ...
  const [waterTotal, setWaterTotal] = useState(2225);
  const [wellTotal, setWellTotal] = useState(1809);
  const { selectLan } = props;

  const regionWaterTotal = (region) => {
    if (region == "Buxoro") {
      setWaterTotal(281);
    } else if (region == "Xorazm") {
      setWaterTotal(107);
    } else if (region == "Qoraqalpog'iston") {
      setWaterTotal(128);
    } else if (region == "Navoi") {
      setWaterTotal(125);
    } else if (region == "Samarqand") {
      setWaterTotal(105);
    } else if (region == "Qashqadarya") {
      setWaterTotal(71);
    } else if (region == "Surxandaryo") {
      setWaterTotal(120);
    } else if (region == "Andijon") {
      setWaterTotal(97);
    } else if (region == "Farg'ona") {
      setWaterTotal(646);
    } else if (region == "Namangan") {
      setWaterTotal(111);
    } else if (region == "Jizzax") {
      setWaterTotal(255);
    } else if (region == "Sirdaryo") {
      setWaterTotal(32);
    } else if (region == "Tashkent") {
      setWaterTotal(147);
    }
  };

  const regionWellTotal = (region) => {
    if (region == "Buxoro") {
      setWellTotal(279);
    } else if (region == "Xorazm") {
      setWellTotal(203);
  ...
  return (
    <section className="map">
      <div className="container map_container">
        {selectLan == "uz" ? (
          <h2 className="text-center map-heading m-0">
            {" "}
            <span className="map-heading-span">
              Smart Solutions System
            </span>{" "}
            tomonidan ishlab chiqarilgan va o'rnatilgan qurilmalar
          </h2>
        ) : selectLan == "eng" ? (
          <h2 className="text-center map-heading m-0">
            Devices manufactured and installed by{" "}
            <span className="map-heading-span">Smart Solutions System</span>
          </h2>
        ) : null}

        <div className="map-wrapper d-flex align-items-center justify-content-between flex-wrap">
          <div className="xarita-div" id="xarita-div">
            <svg
              className="uzbxarita"
              baseProfile="tiny"
              fill="#7c7c7c"
            ...
            >
              ...
              <path
                ...
                onClick={() => {
                  ...
                  regionWellTotal("Qoraqalpog'iston");
                  setMapRegion("Qoraqalpog'iston");
                }}
              ...
              ></path>
              <path
                className={`${mapRegion == "Namangan" ? "on" : ""}`}
                onClick={() => {
                  regionWaterTotal("Namangan");
                  regionWellTotal("Namangan");
                  setMapRegion("Namangan");
                }}
              ...
              ></path>
              <path
                className={`${mapRegion == "Sirdaryo" ? "on" : ""}`}
                onClick={() => {
                  regionWaterTotal("Sirdaryo");
                  regionWellTotal("Sirdaryo");
                  setMapRegion("Sirdaryo");
                }}
          ...
          <div className="map-statistic-wrapper">
            <h3 className="text-center map-region-heading fw-bold">
              {mapRegion}
            </h3>

            <div className="d-flex align-items-center justify-content-between">
              <div className="text-center">
                <p className="m-0 map-smart-water-desc">Smart Water</p>
                <p className="m-0 map-smart-water-desc-stat">{waterTotal}</p>
              </div>

              <div className="ms-5 text-center">
                <p className="m-0 map-smart-water-desc">Smart Well</p>
                <p className="m-0 map-smart-water-desc-stat">{wellTotal}</p>
              </div>
            </div>
          </div>
        </div>
