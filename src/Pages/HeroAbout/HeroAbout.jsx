        ...
        <section className="hero__about">
          <div className="container hero__about__container">
            ...
            <ul className="a_hero__left">
              <li><a className="a_hero_link" href="">Kompaniya haqida</a></li>
              <li><a className="a_hero_link" href="#hamkorlar">Hamkorlar</a></li>
              <li><a className="a_hero_link" href="#mijozlarimiz">Bizning mijozlarimiz</a></li>
            </ul>

            <div className="a_hero__right">
              <h3 id="kompaniya" className="a_hero__title">Kompaniya haqida</h3>
              ...
              <h3 id="hamkorlar" className="a_hero__title">Hamkorlar</h3>
              ...
              <h3 id="mijozlarimiz" className="a_hero__title">Bizning mijozlarimiz </h3>
